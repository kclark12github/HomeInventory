...
Begin VB.Form frmArmorCarModels 
   ...
   Begin VB.TextBox txtNotes 
      ...
      MultiLine       =   -1  'True
      TabIndex        =   10
      Text            =   "frmArmorCarModels.frx":0000
      Top             =   2160
      Width           =   5652
   End
   ...
   Begin MSComctlLib.ImageList imlSmall 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":0008
            Key             =   "Modify"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":0324
            Key             =   "Find"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":0640
            Key             =   "Delete"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":0A94
            Key             =   "List"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":1560
            Key             =   "Copy"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":222C
            Key             =   "New2"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":2CF8
            Key             =   "Delete2"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":37C4
            Key             =   "Modify2"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":4290
            Key             =   "New"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":4D5C
            Key             =   "Report"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imlLarge 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   10
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":51B0
            Key             =   "Report"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":5604
            Key             =   "Modify"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":5920
            Key             =   "Find"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":5C3C
            Key             =   "New2"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":6708
            Key             =   "Copy"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":73D4
            Key             =   "List"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":7EA0
            Key             =   "Delete2"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":896C
            Key             =   "Modify2"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":9438
            Key             =   "New"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmArmorCarModels.frx":9F04
            Key             =   "Delete"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmArmorCarModels"
...
Dim WithEvents rsArmorCarModels As ADODB.Recordset
Attribute rsArmorCarModels.VB_VarHelpID = -1
...
Private Sub cmdOK_Click()
    ...
    Select Case mode
        ...
        Case modeAdd, modeModify
            ...
            rsArmorCarModels("Manufacturer") = dbcManufacturer.BoundText
            rsArmorCarModels("Catalog") = dbcCatalog.BoundText
            rsArmorCarModels.UpdateBatch
            adoConn.CommitTrans
            fTransaction = False
            frmMain.ProtectFields Me
            mode = modeDisplay
...
Private Sub Form_Load()
    ...
    Set rsArmorCarModels = New ADODB.Recordset
    ...
    End With
    rsArmorCarModels.CursorLocation = adUseClient
    rsArmorCarModels.Open "select * from [Armor & Car Models] order by Scale,Designation,Name", adoConn, adOpenKeyset, adLockBatchOptimistic
    
    rsManufacturers.CursorLocation = adUseClient
    rsManufacturers.Open "select distinct Manufacturer from [Armor & Car Models] order by Manufacturer", adoConn, adOpenStatic, adLockReadOnly
    
    rsCatalogs.CursorLocation = adUseClient
    rsCatalogs.Open "select distinct Catalog from [Armor & Car Models] order by Catalog", adoConn, adOpenStatic, adLockReadOnly
    
    rsScales.CursorLocation = adUseClient
    rsScales.Open "select distinct Scale from [Armor & Car Models] order by Scale", adoConn, adOpenStatic, adLockReadOnly
    
    rsNations.CursorLocation = adUseClient
    rsNations.Open "select distinct Nation from [Armor & Car Models] order by Nation", adoConn, adOpenStatic, adLockReadOnly
    
    rsTypes.CursorLocation = adUseClient
    rsTypes.Open "select distinct Type from [Armor & Car Models] order by Type", adoConn, adOpenStatic, adLockReadOnly
    
    Set adodcHobby.Recordset = rsArmorCarModels
    frmMain.BindField lblID, "ID", rsArmorCarModels
    frmMain.BindField dbcManufacturer, "Manufacturer", rsArmorCarModels, rsManufacturers, "Manufacturer", "Manufacturer"
    frmMain.BindField txtDesignation, "Designation", rsArmorCarModels
    frmMain.BindField txtName, "Name", rsArmorCarModels
    frmMain.BindField txtPrice, "Price", rsArmorCarModels
    frmMain.BindField dbcScale, "Scale", rsArmorCarModels, rsScales, "Scale", "Scale"
    frmMain.BindField txtReference, "Reference", rsArmorCarModels
    frmMain.BindField dbcCatalog, "Catalog", rsArmorCarModels, rsCatalogs, "Catalog", "Catalog"
    frmMain.BindField dbcNation, "Nation", rsArmorCarModels, rsNations, "Nation", "Nation"
    frmMain.BindField dbcType, "Type", rsArmorCarModels, rsTypes, "Type", "Type"
    frmMain.BindField txtCount, "Count", rsArmorCarModels
    frmMain.BindField txtNotes, "Notes", rsArmorCarModels
    frmMain.BindField txtInventoried, "DateInventoried", rsArmorCarModels
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    If Not rsArmorCarModels.EOF Then
        If rsArmorCarModels.EditMode <> adEditNone Then rsArmorCarModels.CancelUpdate
    End If
    If (rsArmorCarModels.State And adStateOpen) = adStateOpen Then rsArmorCarModels.Close
    Set rsArmorCarModels = Nothing
...
Private Sub mnuActionList_Click()
    ...
    Set frmList.rsList = rsArmorCarModels
...
Private Sub mnuActionDelete_Click()
    ...
    If MsgBox("Are you sure you want to permanently delete this record...?", vbYesNo, Me.Caption) = vbYes Then
        rsArmorCarModels.Delete
        rsArmorCarModels.MoveNext
        If rsArmorCarModels.EOF Then rsArmorCarModels.MoveLast
    End If
    mode = modeDisplay
End Sub
...
Private Sub mnuActionReport_Click()
    ...
    'Report.Database.SetDataSource rsArmorCarModels, 3, 1
    ...
    'Set Report = Nothing
End Sub
Private Sub rsArmorCarModels_MoveComplete(ByVal adReason As ADODB.EventReasonEnum, ByVal pError As ADODB.Error, adStatus As ADODB.EventStatusEnum, ByVal pRecordset As ADODB.Recordset)
    Dim Caption As String
    Dim i As Integer
    
    On Error GoTo ErrorHandler
    If rsArmorCarModels.BOF And rsArmorCarModels.EOF Then
        Caption = "No Records"
    ElseIf rsArmorCarModels.EOF Then
        Caption = "EOF"
    ElseIf rsArmorCarModels.BOF Then
        Caption = "BOF"
    Else
        If IsNumeric(rsArmorCarModels("Scale")) Then
            Caption = "Reference #" & rsArmorCarModels.Bookmark & ": 1/" & rsArmorCarModels("Scale") & " Scale; " & rsArmorCarModels("Designation") & " " & rsArmorCarModels("Name")
        Else
            Caption = "Reference #" & rsArmorCarModels.Bookmark & ": " & rsArmorCarModels("Scale") & " Scale; " & rsArmorCarModels("Designation") & " " & rsArmorCarModels("Name")
        End If
