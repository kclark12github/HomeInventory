...
Begin VB.Form frmCarCollectables 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Car Collectables"
   ClientHeight    =   5625
   ClientLeft      =   30
   ClientTop       =   495
   ClientWidth     =   8100
   Icon            =   "frmCarCollectables.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   5625
   ...
   Begin VB.Frame fraCarCollectables 
      Height          =   3675
      Index           =   0
      Left            =   180
      TabIndex        =   17
      ...
      Begin PVCurrencyLib.PVCurrency pvcValue 
         Bindings        =   "frmCarCollectables.frx":08CA
         Height          =   285
         Left            =   3525
         TabIndex        =   5
         Top             =   900
      ...
      Begin PVCurrencyLib.PVCurrency pvcPrice 
         Bindings        =   "frmCarCollectables.frx":08D5
         Height          =   285
         Left            =   1530
         TabIndex        =   4
         Top             =   900
   ...
   Begin VB.Frame fraCarCollectables 
      ...
      Begin RichTextLib.RichTextBox rtxtNotes 
         ...
         _ExtentY        =   6059
         _Version        =   393217
         TextRTF         =   $"frmCarCollectables.frx":08E0
      End
   End
   ...
   Begin MSAdodcLib.Adodc adodcMain 
      ...
      _Version        =   393216
   End
   Begin MSComctlLib.TabStrip tsCarCollectables 
      Height          =   4035
      Left            =   120
      TabIndex        =   0
      Top             =   360
   ...
   Begin MSComctlLib.ImageList imlSmall 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCarCollectables.frx":09A9
            Key             =   "Find"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCarCollectables.frx":0CC5
            Key             =   "Warning"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCarCollectables.frx":0FED
            Key             =   "List"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCarCollectables.frx":1315
            Key             =   "xNew"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCarCollectables.frx":3AC9
            Key             =   "Stop"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCarCollectables.frx":3F1D
            Key             =   "Report"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCarCollectables.frx":4371
            Key             =   "Modify"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCarCollectables.frx":4E3D
            Key             =   "Refresh"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCarCollectables.frx":5165
            Key             =   "Sort"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCarCollectables.frx":55B9
            Key             =   "SQL"
         EndProperty
         BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCarCollectables.frx":5A0D
            Key             =   "Search"
         EndProperty
         BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCarCollectables.frx":5E61
            Key             =   "Filter"
         EndProperty
         BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCarCollectables.frx":62B9
            Key             =   "Delete"
         EndProperty
         BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCarCollectables.frx":6415
            Key             =   "Blank"
         EndProperty
         BeginProperty ListImage15 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmCarCollectables.frx":6571
            Key             =   "NewRecord"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmCarCollectables"
...
Private Sub Form_Load()
    ...
    SQLmain = "select * from [Car Collectables] order by Manufacturer,Type,Series,Reference"
    ...
    rsManufacturers.Open "select distinct Manufacturer from [Car Collectables] order by Manufacturer", adoConn, adOpenStatic, adLockReadOnly
    DBcollection.Add "rsManufacturers", rsManufacturers
    
    rsSeries.CursorLocation = adUseClient
    rsSeries.Open "select distinct Series from [Car Collectables] order by Series", adoConn, adOpenStatic, adLockReadOnly
    DBcollection.Add "rsSeries", rsSeries
    
    rsTypes.CursorLocation = adUseClient
    rsTypes.Open "select distinct Type from [Car Collectables] order by Type", adoConn, adOpenStatic, adLockReadOnly
    DBcollection.Add "rsTypes", rsTypes
    
    rsConditions.CursorLocation = adUseClient
    rsConditions.Open "select distinct Condition from [Car Collectables] order by Condition", adoConn, adOpenStatic, adLockReadOnly
    DBcollection.Add "rsConditions", rsConditions
    
    rsLocations.CursorLocation = adUseClient
    rsLocations.Open "select distinct Location from [Car Collectables] order by Location", adoConn, adOpenStatic, adLockReadOnly
    ...
    Set tsCarCollectables.SelectedItem = tsCarCollectables.Tabs(1)
    ProtectFields Me
    mode = modeDisplay
    fTransaction = False
End Sub
...
Private Sub mnuFileReport_Click()
    ReportCommand Me, rsMain, App.Path & "\Reports\CarCollectables.rpt"
End Sub
Private Sub mnuFileSQL_Click()
    SQLCommand "Car Collectables"
End Sub
...
Private Sub tbMain_ButtonClick(ByVal Button As MSComCtlLib.Button)
    ...
    End Select
End Sub
Private Sub tsCarCollectables_Click()
    Dim i As Integer
    
    With tsCarCollectables
        For i = 0 To .Tabs.Count - 1
            If i = .SelectedItem.Index - 1 Then
                fraCarCollectables(i).Enabled = True
                fraCarCollectables(i).ZOrder
            Else
                fraCarCollectables(i).Enabled = False
            End If
        Next
    End With
End Sub
