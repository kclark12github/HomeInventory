...
Begin VB.Form frmFinishingProducts 
   ...
   Begin MSComctlLib.ImageList imlLarge 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   8
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFinishingProducts.frx":63D8
            Key             =   "Report"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFinishingProducts.frx":682C
            Key             =   "Modify"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFinishingProducts.frx":72F8
            Key             =   "Find"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFinishingProducts.frx":7614
            Key             =   "List"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFinishingProducts.frx":80E0
            Key             =   "Delete"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFinishingProducts.frx":8534
            Key             =   ""
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFinishingProducts.frx":ACE8
            Key             =   ""
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmFinishingProducts.frx":B13C
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub Form_Load()
    ...
    rsMain.Open "select * from [Paints & Brushes] order by Type,Name", adoConn, adOpenKeyset, adLockBatchOptimistic
...
Private Sub mnuActionReport_Click()
    ...
    Set Report = scrApplication.OpenReport(App.Path & "\Reports\FinishingProducts.rpt", crOpenReportByTempCopy)
...
Private Sub mnuActionSQL_Click()
    ...
    frmSQL.sbStatus.Panels("DB").Text = "Hobby.mdb - [Paints & Brushes]"
    frmSQL.Show vbModal
End Sub
Private Sub rsMain_MoveComplete(ByVal adReason As ADODB.EventReasonEnum, ByVal pError As ADODB.Error, adStatus As ADODB.EventStatusEnum, ByVal pRecordset As ADODB.Recordset)
    ...
    ElseIf rsMain.BOF Then
        Caption = "BOF"
    Else
        Caption = "Reference #" & rsMain.Bookmark & ": " & rsMain("Type") & ": " & rsMain("Name")
