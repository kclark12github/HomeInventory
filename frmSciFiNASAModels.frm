...
Private Sub Form_Unload(Cancel As Integer)
    ...
    If Not rsSciFiNASAModels.EOF Then
        If rsSciFiNASAModels.EditMode <> adEditNone Then rsSciFiNASAModels.CancelUpdate
    End If
    If (rsSciFiNASAModels.State And adStateOpen) = adStateOpen Then rsSciFiNASAModels.Close
...
Private Sub rsSciFiNASAModels_MoveComplete(ByVal adReason As ADODB.EventReasonEnum, ByVal pError As ADODB.Error, adStatus As ADODB.EventStatusEnum, ByVal pRecordset As ADODB.Recordset)
    ...
    ElseIf rsSciFiNASAModels.BOF Then
        Caption = "BOF"
    Else
        If IsNumeric(rsSciFiNASAModels("Scale")) Then
        ...
        Else
            Caption = "Reference #" & rsSciFiNASAModels.Bookmark & ": " & rsSciFiNASAModels("Scale") & " Scale; " & rsSciFiNASAModels("Designation") & " " & rsSciFiNASAModels("Name")
        End If
        i = InStr(Caption, "&")
