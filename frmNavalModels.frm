...
Begin VB.Form frmNavalModels 
   ...
   Begin MSComctlLib.ImageList imlSmall 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":0000
            Key             =   "Modify"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":031C
            Key             =   "Find"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":0638
            Key             =   "Delete"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":0A8C
            Key             =   "List"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":1558
            Key             =   "Copy"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":2224
            Key             =   "New2"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":2CF0
            Key             =   "Delete2"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":37BC
            Key             =   "Modify2"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":4288
            Key             =   "New"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":4D54
            Key             =   "Report"
         EndProperty
      EndProperty
   End
   Begin MSComctlLib.ImageList imlLarge 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   10
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":51A8
            Key             =   "Report"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":55FC
            Key             =   "Modify"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":5918
            Key             =   "Find"
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":5C34
            Key             =   "New2"
         EndProperty
         BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":6700
            Key             =   "Copy"
         EndProperty
         BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":73CC
            Key             =   "List"
         EndProperty
         BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":7E98
            Key             =   "Delete2"
         EndProperty
         BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":8964
            Key             =   "Modify2"
         EndProperty
         BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":9430
            Key             =   "New"
         EndProperty
         BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "frmNavalModels.frx":9EFC
            Key             =   "Delete"
         EndProperty
      EndProperty
   End
   ...
   End
End
Attribute VB_Name = "frmNavalModels"
...
Dim WithEvents rsNavalModels As ADODB.Recordset
Attribute rsNavalModels.VB_VarHelpID = -1
...
Private Sub cmdOK_Click()
    ...
    Select Case mode
        ...
        Case modeAdd, modeModify
            ...
            rsNavalModels("Manufacturer") = dbcManufacturer.BoundText
            rsNavalModels("Catalog") = dbcCatalog.BoundText
            ...
            SaveBookmark = rsNavalModels("Reference")
            rsNavalModels.Requery
            rsNavalModels.Find "Reference='" & SQLQuote(SaveBookmark) & "'"
...
Private Sub Form_Load()
    ...
    Set rsNavalModels = New ADODB.Recordset
    ...
    rsCatalogs.Open "select distinct Catalog from [Naval Models] order by Catalog", adoConn, adOpenStatic, adLockReadOnly
    
    rsScales.CursorLocation = adUseClient
    rsScales.Open "select distinct Scale from [Naval Models] order by Scale", adoConn, adOpenStatic, adLockReadOnly
    
    rsNations.CursorLocation = adUseClient
    rsNations.Open "select distinct Nation from [Naval Models] order by Nation", adoConn, adOpenStatic, adLockReadOnly
    
    Set adodcHobby.Recordset = rsNavalModels
    frmMain.BindField lblID, "ID", rsNavalModels
    frmMain.BindField dbcManufacturer, "Manufacturer", rsNavalModels, rsManufacturers, "Manufacturer", "Manufacturer"
    frmMain.BindField txtDesignation, "Designation", rsNavalModels
    frmMain.BindField txtName, "Name", rsNavalModels
    frmMain.BindField txtPrice, "Price", rsNavalModels
    frmMain.BindField dbcScale, "Scale", rsNavalModels, rsScales, "Scale", "Scale"
    frmMain.BindField txtReference, "Reference", rsNavalModels
    frmMain.BindField dbcCatalog, "Catalog", rsNavalModels, rsCatalogs, "Catalog", "Catalog"
    frmMain.BindField dbcNation, "Nation", rsNavalModels, rsNations, "Nation", "Nation"
    frmMain.BindField txtCount, "Count", rsNavalModels
    frmMain.BindField txtInventoried, "DateInventoried", rsNavalModels
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    If Not rsNavalModels.EOF Then
        If rsNavalModels.EditMode <> adEditNone Then rsNavalModels.CancelUpdate
    End If
    If (rsNavalModels.State And adStateOpen) = adStateOpen Then rsNavalModels.Close
    Set rsNavalModels = Nothing
...
Private Sub mnuActionList_Click()
    ...
    Set frmList.rsList = rsNavalModels
...
Private Sub mnuActionDelete_Click()
    ...
    If MsgBox("Are you sure you want to permanently delete this record...?", vbYesNo, Me.Caption) = vbYes Then
        rsNavalModels.Delete
        rsNavalModels.MoveNext
        If rsNavalModels.EOF Then rsNavalModels.MoveLast
    End If
    mode = modeDisplay
End Sub
...
Private Sub mnuActionReport_Click()
    ...
    'Report.Database.SetDataSource rsNavalModels, 3, 1
    ...
    'Set Report = Nothing
End Sub
Private Sub rsNavalModels_MoveComplete(ByVal adReason As ADODB.EventReasonEnum, ByVal pError As ADODB.Error, adStatus As ADODB.EventStatusEnum, ByVal pRecordset As ADODB.Recordset)
    Dim Caption As String
    Dim i As Integer
    
    On Error GoTo ErrorHandler
    If rsNavalModels.BOF And rsNavalModels.EOF Then
        Caption = "No Records"
    ElseIf rsNavalModels.EOF Then
        Caption = "EOF"
    ElseIf rsNavalModels.BOF Then
        Caption = "BOF"
    Else
        If IsNumeric(rsNavalModels("Scale")) Then
            Caption = "Reference #" & rsNavalModels.Bookmark & ": 1/" & rsNavalModels("Scale") & " Scale; " & rsNavalModels("Designation") & " " & rsNavalModels("Name")
        Else
            Caption = "Reference #" & rsNavalModels.Bookmark & ": " & rsNavalModels("Scale") & " Scale; " & rsNavalModels("Designation") & " " & rsNavalModels("Name")
        End If
